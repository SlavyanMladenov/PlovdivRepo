        ...
        public class Morph
        {
            ...
            private void Update()
            {
                ...
                for (int i = 0; i < computer.pointCount; i++)
                {
                    ...
                    computer.spline.points[i].type = SplinePoint.Type.Broken;
                    computer.spline.points[i].position = pos;
                    computer.spline.points[i].tangent = tan;
                    computer.spline.points[i].tangent2 = tan2;
                    computer.spline.points[i].normal = normal;
                    computer.spline.points[i].color = col;
                    computer.spline.points[i].size = size;
                }
                computer.Rebuild();
            }
