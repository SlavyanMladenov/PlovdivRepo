...
namespace Dreamteck.Splines
{
    public class MorphWindow : SplineEditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            Rect viewRect = new Rect(0, 0, Screen.width - 30, 54 * names.Length);
            scroll = GUI.BeginScrollView(new Rect(0, 0, Screen.width, Mathf.Min(73 * names.Length, 54 * 4)), scroll, viewRect);
            ...
            GUI.EndScrollView();
            Rect rect = new Rect(0, Mathf.Min(73 * names.Length, 54 * 4) + 30, Screen.width, 100);
