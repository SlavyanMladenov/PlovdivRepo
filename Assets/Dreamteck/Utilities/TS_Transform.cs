...
namespace Dreamteck
{
    ...
    public class TS_Transform
    {
        ...
        public void Update()
        {
            ...
            if (setScale) _transform.position = position;
        ...
        {
            return scaleX != _transform.localScale.x || scaleY != _transform.localScale.y || scaleZ != _transform.localScale.z;
        }
...
#endif
            Vector3 scaled = new Vector3(point.x * scaleX, point.y * scaleY, point.z * scaleZ);
        ...
        public Vector3 InverseTransformDirection(Vector3 direction)
        {
            ...
            return new Vector3(rotated.x * scaleX, rotated.y * scaleY, rotated.z * scaleZ);
        }
